                ...
                <div class="col-sm-8">
                    <div class="shop-menu pull-right">
                        <ul class="nav navbar-nav">
                            ...
                            <?php if(User::isGuest()): ?>
                            <li><a href="http://eshop/user/register"><i class="fa fa-user"></i> Регистрация</a></li>
                            <li><a href="http://eshop/user/login"><i class="fa fa-lock"></i> Вход</a></li>
                            <?php else: ?>
                            <li><a href="/account"><i class="fa fa-user"></i> Аккаунт</a></li>
                            <li><a href="http://eshop/user/logout"><i class="fa fa-unlock"></i> Выход</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </div>
